...
\begin{figure}[htb]
  \centering
  \includegraphics[width=1\linewidth]{migration-steps-overview.pdf}
...
capabilities. We are able to see the same pros and cons in our monorepo.
...
\begin{figure}
  \centering
  \includegraphics[width=1\linewidth]{step2-modularization-flow.pdf}
...
\subsection{Versioned Dependency Management}
...
\textbf{Cross-product component reuse:} Independant of an SPL introduction, it
